...
%实验名称CFS_PLUS
Preferences.Experiment.Name = 'CFS_XPlus';
...
%global parameters
%下面有几个参数不同电脑上需要改
Preferences.SkipPTBSyncTests=0;
